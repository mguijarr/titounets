...
class Login extends React.Component {
  constructor(props) {
    super(props);
    this.state = { loggedIn: auth.loggedIn(), admin: false, loggedInUser: null };
    this.signIn = this.signIn.bind(this);
    this.signOut = this.signOut.bind(this);
    this.updateLoginState = this.updateLoginState.bind(this);
  }

  updateLoginState(loggedIn, admin) {
  ...
  render() {
    if (this.state.loggedIn) {
      ...
      return (<form className="navbar-form" action="">
                    ...
                    <FormControl type="password" ref="password" name="password" placeholder="Mot de passe" onKeyDown={this.signIn}/>{' '}
