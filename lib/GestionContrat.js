...
export default class GestionContrat extends React.Component { // eslint-disable-line react/prefer-stateless-function
  ...
  componentWillMount() {
    ...
    this.holidays = [{ 'start': [2016, 10, 20], 'end': [2016, 11, 3] }, { 'start': [2016, 12, 17], 'end': [2017, 1, 3] }, { 'start': [2017, 2, 18], 'end': [2017, 3, 6] }, { 'start': [2017, 4, 15], 'end': [2017, 5, 2] }, { 'start': [2017, 10, 21], 'end': [2017, 11, 6] }, { 'start': [2017, 12, 23], 'end': [2018, 1, 8] }, { 'start': [2018, 2, 10], 'end': [2018, 2, 26] }, { 'start': [2018, 4, 7], 'end': [2018, 4, 23] }];
    this.setState({ checked: { 'Sara': true, 'Elias': true },
                    periods: [{ name: 'Sara', periods: [] },
                               { name: 'Elias', periods: [] }],
    });
  }
  ...
  render() {
    const customCss = {
      holiday: (day) => { for (const d of this.holidays) {
        if (day._isValid) {
