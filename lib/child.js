  ...
  render() {
        return <Form horizontal>
             <FormGroup> 
               ...
               <Col sm={4}>
                 <FormControl readOnly={this.state.readOnly} type="text" ref='childSurname' placeholder="Martin"/>
               </Col>
               <Col sm={2} componentClass={ControlLabel}>Pr&eacute;nom</Col>
               <Col sm={4}>
                 <FormControl readOnly={this.state.readOnly} type="text" ref='childName' placeholder="Lea"/>
               </Col>
             </FormGroup>
             <FormGroup> 
               ...
               <Col sm={10}>
                 <DatePicker disabled={this.state.readOnly} ref='birthdate' 
                   ...
                   dayLabels={['Dim', 'Lun', 'Mar', 'Mer', 'Jeu', 'Ven', 'Sam']} dateFormat="DD/MM/YYYY"
                 />
               </Col>
             </FormGroup>
             <FormGroup>
