  ...
  loadFamily(selectedFamily) {
    ...
    if (! selectedFamily) {
      ...
      fetch("/family/"+selectedFamily, {
        ...
        formValues.qf = res.qf;
        formValues.parent1 = res.parents[0];
        formValues.parent2 = res.parents[1];
        formValues.address1 = res.address.street[0];
        formValues.address2 = res.address.street[1];
        formValues.zip = res.address.zip;
        formValues.city = res.address.city;
        formValues.email = res.email;
        formValues.phone_number = res.phone_number;
        formValues.active = res.active;
         
        this.setState({ selectedFamily, formValues, family: { [selectedFamily]: res } });
      });
    }
  }
