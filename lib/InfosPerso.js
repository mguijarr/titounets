...
export default class InfosPerso extends React.Component { // eslint-disable-line react/prefer-stateless-function
  ...
  componentWillMount() {
    ...
    this.setState({ adminView: auth.loggedIn() && auth.admin(), selectedFamily });
    ...
    if (this.state.adminView) { 
        ...
        fetch("/families", {
            ...
            this.setState({families: res.families, family: res.family});
        });
    } else { 
      // get one family
      fetch("/family/"+selectedFamily, {
          ...
          this.setState({family: res, families: { [selectedFamily]: res }});
      });
    }
  }
            ...
            <Row>
              <Form horizontal>
                <FormGroup>
                  ...
                  <Col sm={4}>
                    <FormControl readOnly={!this.state.adminView} ref="familyId" type="text" value={family.id}/>
                  </Col>
                  <Col sm={2}>
                    { this.state.adminView ? (
                  ...
                  <Col sm={2}>
                    <FormControl readOnly={!this.state.adminView} type="text" ref="qf" value={family.qf}/>
                  </Col>
                </FormGroup>
                <FormGroup>
                ...
                <FormGroup>
                  ...
                  <Col sm={3}>
                    <FormControl type="text" ref="phone_number" />
                  </Col>
                </FormGroup>
             </Form>
          </Row>
