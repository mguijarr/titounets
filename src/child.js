  ...
  render() {
        return <Form horizontal>
             <FormGroup> 
               ...
               <Col sm={4}>
                 <FormControl readOnly={this.state.readOnly} type="text" ref='childSurname' value={this.props.data.surname}/>
               </Col>
               <Col sm={2} componentClass={ControlLabel}>Pr&eacute;nom</Col>
               <Col sm={4}>
                 <FormControl readOnly={this.state.readOnly} type="text" ref='childName' value={this.props.data.name}/>
               </Col>
             </FormGroup>
             <FormGroup> 
