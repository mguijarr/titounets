...
export default class InfosPerso extends React.Component {
  ...
  loadFamily(selectedFamily, stateDict) {
    ...
    if (!selectedFamily) {
      ...
      this.setState({
        busy: false,
        family,
        formValues: { parent1: "", parent2: "", qf: 0 },
        addressFields: {},
        ...stateDict
      });
    } else {
  ...
  render() {
        ...
        return (
          <div>
            ...
            <Button
              ...
              bsSize="xsmall"
              onClick={() => {
                  this.loadFamily(f.id, { showDelFamily: true });
                }}
    ...
    return (
      <Grid>
        <Row>
          {this.state.adminView ? <Col lg={4}>
                <Row>
                  <Col sm={12}>
                    <Button
                      bsStyle="primary"
                      onClick={() => {
                          this.setState({ showAddFamily: true });
                        }}
                    >
